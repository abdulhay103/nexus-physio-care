  ...
  return (
    <section className="section-padding">
      <div className="container">
        <div className="relative h-80 w-full overflow-hidden rounded-md 2xl:h-96">
          <Image
            src={CTAImg}
            fill
          ...
          <div className="absolute left-0 top-0 flex h-full w-full items-center justify-center bg-cyan-900 opacity-80">
            <div className="font-siliguri">
              ...
              <div className="flex justify-center py-5">
                <Link
                  href={"/contact"}
                  className="rounded-md bg-white px-7 py-3 text-lg font-bold text-cyan-800 2xl:px-10 2xl:py-4"
                >
                  যোগাযোগ
                </Link>
              </div>
